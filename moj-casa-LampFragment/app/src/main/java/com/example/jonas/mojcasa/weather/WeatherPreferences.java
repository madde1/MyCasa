...
public class WeatherPreferences {
    private static final String LOG_TAG = WeatherPreferences.class.getSimpleName();

    public String changeToNoDecimal(Context context, Double d){

        String newValue = Double.toString(Math.floor(d));
        int temperatureFormatResourceId = R.string.format_temperature;
        return String.format(context.getString(temperatureFormatResourceId), d);
    }
